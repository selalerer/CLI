package com.checkmarx.cxconsole.clients.rest.login;

import com.checkmarx.cxconsole.clients.rest.exceptions.CxRestClientValidatorException;
import com.checkmarx.cxconsole.clients.rest.login.dto.RestGetAccessTokenDTO;
import com.checkmarx.cxconsole.clients.rest.login.dto.RestLoginResponseDTO;
import com.checkmarx.cxconsole.clients.rest.login.exceptions.CxRestLoginClientException;
import com.checkmarx.cxconsole.clients.rest.utils.RestClientUtils;
import com.checkmarx.cxconsole.clients.rest.utils.RestHttpEntityBuilder;
import com.checkmarx.cxconsole.clients.rest.utils.RestResourcesURIBuilder;
import com.checkmarx.cxconsole.clients.rest.login.jwt.dto.JwtAccessTokenDto;
import com.checkmarx.cxconsole.clients.rest.login.jwt.exceptions.JWTException;
import com.checkmarx.cxconsole.clients.rest.login.jwt.utils.JwtUtils;
...
import static com.checkmarx.cxconsole.clients.rest.login.CxRestTokenClient.FAIL_TO_AUTHENTICATE_ERROR;
import static com.checkmarx.cxconsole.clients.rest.utils.RestClientUtils.validateResponse;
