package com.checkmarx.cxconsole.exitcodes;
...
public class ErrorHandler {
    ...
    private static Map<String, Integer> createMessageToCodeMap() {
        ...
        messageToCodeMap.put(UNSUCCESSFUL_REST_LOGIN, LOGIN_FAILED_ERROR_EXIT_CODE);
        messageToCodeMap.put(INVALID_CREDENTIALS_FOR_TOKEN_GENERATION, LOGIN_FAILED_ERROR_EXIT_CODE);
