...
public class ConfigMgr {
    ...
    public static final String KEY_REPORT_GENERATION_TIMEOUT_MILLISECONDS = "scan.job.report.generation.timeout";
    public static final String KEY_REPORT_GENERATION_RETRIES_LIMIT = "scan.job.report.generation.retries";
    ...
    protected void loadDefaults() {
        ...
        applicationProperties.put(KEY_REPORT_GENERATION_TIMEOUT_MILLISECONDS, "10000");
        applicationProperties.put(KEY_REPORT_GENERATION_RETRIES_LIMIT, "3");
